...
// pieCrt.style.background = 'conic-gradient(#00b894 0 '+ R +'% , #e74c3c 0 '+ W +'% , #0984e3 0 '+ UM +'% )';
// pieCrt.style.background = 'conic-gradient(#cff5d7  0 '+ R +'% , #f3c2c2 0 '+ W +'% , #d2e9fe 0 '+ UM +'% )';
// pieCrt.style.background = 'conic-gradient(#b5f7e9 0 '+ R +'% ,#fccac5 0 '+ W +'% , #afd8ff 0 '+ UM +'% )';
...
submit.addEventListener('click', function () {
    ...
    // setTimer();
    // setTimeout(function() {
    //     Q_Box.classList.remove('anim');
    // }, 700);

    // setTimeout(function() {
    //     Q_Box.classList.add('inactive');
    // }, 800);

    // setTimeout(function() {
    //     Q_Box.classList.remove('inactive');
    //     Q_Box.classList.remove('active');
    // }, 1400);

    // setTimeout(function() {
    //     R_Box.classList.add('active');
    //     // aBody.classList.add('active');
    // }, 1500);

    // setTimeout(function() {
    //     R_Box.classList.add('anim');
    // }, 1600);
});
...
function quizResult() {
    ...
    R_Box.querySelector('.total-attempt').innerHTML = rightAns + wrongAns;
    ...
    pieCrt.style.background =
        'conic-gradient(#b5f7e9 0 ' +
        R +
        '% ,#fccac5 0 ' +
        M +
        '% , #afd8ff 0 100% )';
...
start.addEventListener('click', function () {
    ...
    //     setTimeout(function() {
    //         Q_Box.classList.add('active');
    //         S_Box.classList.remove('anim');
    //         aBody.classList.remove('active');
    //     }, 1000);

    //     setTimeout(function() {
    //         Q_Box.classList.add('anim');
    //     }, 1100);
});
